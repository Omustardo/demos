...
func (t *Triangle) Center() mgl32.Vec2 {
	x := (t.P1[0] + t.P2[0] + t.P3[0]) / 3
	y := (t.P1[1] + t.P2[1] + t.P3[1]) / 3
	return mgl32.Vec2{x, y}
}

func (t *Triangle) Position() mgl32.Vec3 { // Shape implements entity.Entity - rethink this, right now it's the same as Center().
	return t.Center().Vec3(0)
}
